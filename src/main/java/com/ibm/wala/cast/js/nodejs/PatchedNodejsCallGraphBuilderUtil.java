...
public class PatchedNodejsCallGraphBuilderUtil extends JSCallGraphUtil {
    ...
    public static PropagationCallGraphBuilder makeCGBuilder(File workingDir, File mainFile)
            throws IOException, IllegalArgumentException, WalaException {
        JavaScriptTranslatorFactory translatorFactory = new PatchedCAstRhinoTranslatorFactory();
        ...
        PatchedNodejsRequireTargetSelector requireTargetSelector =
                new PatchedNodejsRequireTargetSelector(workingDir, baseSelector);
