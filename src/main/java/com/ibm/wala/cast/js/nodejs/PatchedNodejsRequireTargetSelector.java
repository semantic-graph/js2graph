 ...
 */
public class PatchedNodejsRequireTargetSelector implements MethodTargetSelector {
    ...
    public PatchedNodejsRequireTargetSelector(File rootDir, MethodTargetSelector base) {
     ...
     */
    private static SourceFileModule loadAsDirectory(File rootDir, File d) throws IOException, JSONException {
        // 1.
